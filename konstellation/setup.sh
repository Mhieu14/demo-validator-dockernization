...
export PERSISTENT_PEERS="00f7f4506d84f9d1458201946e1194564b444ce0@node14.konstellation.tech:26656,06fed4bbe81ead6073a7254e860331179af74f4c@node3.konstellation.tech:26656"
...
rm -r -f /data/
sed -i '/\[instrumentation\]/{:a;n;/prometheus/s/false/true/;Ta}' /config/config.toml
sed -i 's/pruning = \x22default\x22/pruning = \x22nothing\x22/' /config/app.toml
sed -i '/\[grpc\]/,+3 s/enable = false/enable = true/;/\[api\]/,+3 s/enable = false/enable = true/;/\[rosetta\]/,+3 s/enable = true/enable = false/' /config/app.toml
